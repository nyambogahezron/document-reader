...
const FloatingActionButton = ({
  ...
  // Calculate action items position
  const getActionPosition = (index) => {
    ...
    switch (position) {
      ...
      case 'center-left':
        ...
        const itemOffset = spacing * (index - middleIndex);
        return { bottom: itemOffset };
      default:
        return { bottom: offset };
    }
  };
          ...
          <Animated.View
            style={[
              styles.actionLabelContainer,
              {
                ...
                opacity,
                right: position.includes('left') ? 'auto' : actionButtonSize + 12,
                left: position.includes('left') ? actionButtonSize + 12 : 'auto',
              },
            ]}
          >
            <Text
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <MaterialIcons name={mainIcon} size={iconSize} color="white" />
        </Animated.View>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  centerRight: {
    top: '50%',
    right: 20,
    marginTop: -28, // Half of default button size
  },
  centerLeft: {
    top: '50%',
    left: 20,
