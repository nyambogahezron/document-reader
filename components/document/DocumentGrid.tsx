...
interface DocumentGridProps {
	...
	onDocumentLongPress: (document: any) => void;
	onBookmarkPress: (document: any) => void;
	onSharePress: (document: any) => void;
	onMorePress: (document: any) => void;
		...
		>
			...
			>
				<View style={styles.gridRow}>
					{displayDocuments.map((document: any, index: number) => (
						<DocumentItem
							...
							isBookmarked={bookmarkedDocuments.some(
								(bookmarked: any) => bookmarked.uri === document.uri
							)}
